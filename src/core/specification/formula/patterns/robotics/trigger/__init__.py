...
from core.specification.formula.atom.pattern.robotics import RoboticPattern
...
class Trigger(RoboticPattern):
    ...
    def process_bin_input(
        pre: Union[Specification, Boolean], post: Union[Specification, Boolean]
    ) -> Tuple[Typeset, str, str]:
