...
def modified():
    from core.specification.atom.pattern.robotics.trigger.triggers_modified import InstantaneousReaction, PromptReaction, \
...
def original():
    from core.specification.atom.pattern.robotics.trigger.triggers import InstantaneousReaction, PromptReaction, \
        DelayedReaction, BoundReaction, BoundDelay, Wait
    modified_patterns = []
