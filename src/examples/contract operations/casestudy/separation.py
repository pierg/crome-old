...
assert set(library_1_goal_z.specification.typeset).intersection(original.specification.typeset)
...
print("we can go back to the original 'original_goal' specification my separating "
