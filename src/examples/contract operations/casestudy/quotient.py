...
patrol = Node(name="always_visit_r5_r4",
...
library_1_goal_x = Node(name="always_visit_r5",
                        description="patrolling of r5",
                        specification=Patrolling([w["r5"]]),
                        world=w)
print("we found a goal in library 1 which has some common variables but does not refine 'patrol'")
assert set(library_1_goal_x.specification.typeset).intersection(patrol.specification.typeset)
...
library_2_goal_y = Node(name="always_visit_r4",
