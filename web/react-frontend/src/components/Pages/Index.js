            ...
            <div className="container px-0 mx-auto ">
                <div className="flex flex-wrap">
                    <div className="w-full px-12 pt-20 text-center flex-1 rounded border border-solid border-blueGray-100">
                        <div> <h3 className="text-2xl mb-2 font-light leading-normal"> Create your own CGG</h3></div>
                    ...
                    <div className="w-full px-4 flex-1">
                        ...
                        <div className="w-full px-12 pt-20 text-center flex-1 rounded border border-solid border-blueGray-100">
                      <div><h3 className="text-2xl mb-2 font-light leading-normal ">Load an existing example of CGG</h3></div>
                      <div className="pt-6"><button className="text-lightBlue-600 bg-transparent border border-solid border-indigo-500 hover:bg-indigo-500 hover:text-white active:bg-blueGray-50 font-bold uppercase text-sm px-6 py-3 rounded outline-none focus:outline-none mr-1 mb-4 ease-linear transition-all duration-150" type="button">
